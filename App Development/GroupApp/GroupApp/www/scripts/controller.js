...
function getStudentResult(input) {
    var json = makeJSON(input);
    var data = makeJSON(json.data);
    var ansA = 0;
    var ansB = 0;
    var ansC = 0;
    var ansD = 0;
    ...
    for (var key in data) {
        ...
        if (data[key].awnser=="C") ansC=data[key].count;
        if (data[key].awnser=="D") ansD=data[key].count;
    }
