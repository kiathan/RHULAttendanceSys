...
Timetable.Renderer = function(e) {
    ...
    function() {
        ...
        Timetable.prototype = {
            ...
            addEvent: function(e, t, n, r, i, att) {
            ...
            draw: function(e) {
                ...
                function d(e, t) {
                    var n = e.url,
						...
						if(e.attended == false){
							 o.title = e.name, n && (o.href = e.url), o.className = "time-entry hasnotattended", o.style.width = h(e), o.style.left = f(e), a.textContent = e.name;
						}   else {
