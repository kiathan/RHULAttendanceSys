            ...
            <form class="form-horizontal" method="post" action="/auth/update">
                ...
                <div class="modal-body">
                    ...
                    <fieldset class="form-group">
                        ...
                        <div class="col-sm-1">
                            <label style="margin:auto;"><input type="checkbox"
                                                               onclick="toggleDisabled('#edit_username')"> Edit </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="form-group">
                        ...
                        <div class="col-sm-1">
                            <label style="margin:auto;"><input type="checkbox"
                                                               onclick="toggleDisabled('#edit_password')"> Edit </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="form-group">
                        ...
                        <div class="col-sm-1">
                            <label style="margin:auto;"><input type="checkbox"
                                                               onclick="toggleDisabled('#edit_firstname')"> Edit
                            </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="form-group">
                        ...
                        <div class="col-sm-1">
                            <label style="margin:auto;"><input type="checkbox"
                                                               onclick="toggleDisabled('#edit_middlename')"> Edit
                            </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="form-group">
                        ...
                        <div class="col-sm-1">
                            <label style="margin:auto;"><input type="checkbox"
                                                               onclick="toggleDisabled('#edit_lastname')"> Edit </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="form-group">
                        ...
                        <div class="col-sm-1">
                            <label style="margin:auto;"><input type="checkbox" onclick="toggleDisabled('#edit_email')">
                                Edit </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="form-group">
                        ...
                        <div class="col-sm-1">
                            <label style="margin:auto;"><input type="checkbox" onclick="toggleDisabled('#edit_role')">
                                Edit </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="form-group">
                        <label for="courses[]" class="col-sm-2 control-label"> Attending </label>
                        <div class="col-sm-4">
                            <select multiple name="non-courses[]" class="edit_courses form-control" id="no-course"
                                    disabled>
                                @foreach($courses as $course)
                                    <option value="{{$course->id}}">({{$course->code}}) - {{$course->name}}</option>
                                @endforeach
                        ...
                        <div class="col-sm-4">
                            <select multiple name="courses[]" class="edit_courses form-control" id="yes-course"
                                    disabled>

                            </select>
                        </div>
                        <div class="col-sm-1">
                            <label style="margin:auto;"><input type="checkbox" onclick="toggleDisabled('.edit_courses')"">
                                Edit </label>
                        </div>
                    </fieldset>
    ...
    <div class="col-xs-10 col-xs-offset-1 col-md-8 col-md-offset-2">
        <div class="row">
                ...
                <div class="input-group">
                    ...
                    <div class="input-group-btn">
                        <button type="submit" class="btn btn-default dropdown-toggle" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">Search <span class="caret"></span></button>
            ...
            <div class="col-xs-2 col-md-1">
                <a type="button" href="#add-user" data-toggle="modal" class="btn btn-default" data-toggle="tooltip"
                   title="Add User"><span class="glyphicon glyphicon-plus"></span></a>
            </div>
    ...
    <ul class="list-group col-xs-10 col-xs-offset-1 col-md-8 col-md-offset-2" style="padding-right:0;" id="user-list">
        @foreach($users as $user)
            <li class="list-group-item">{{$user->firstname}} {{$user->lastname}}
                <a href="#check" onclick="checkUpdate('{{$user->firstname}}', '{{$user->lastname}}', {{$user->id}})"
                   data-toggle="modal" data-toggle="tooltip" title="Delete User" class="glyphicon glyphicon-trash"
                   style="float:right; margin-left:1em;"></a>
                <a href="#edit-user" onclick="editUpdate({{$user->id}})" data-toggle="modal" data-toggle="tooltip"
                   title="Edit User" class="glyphicon glyphicon-pencil" style="float:right; margin-left:1em;"></a>
                <a href="#view" onclick="viewUpdate({{$user->id}})" data-toggle="modal" data-toggle="tooltip"
                   title="View User" class="glyphicon glyphicon-search" style="float:right; margin-left:1em;"></a>
            </li>
        @endforeach
    </ul>
</div>
